...
def train(args):
    ...
    torch.save(model, f'../models/{args.i}/LSTM_{args.lookafter}_R[{load_model_round + args.n_epochs}]_L[{args.num_layers}]_size[{args.hidden_size}].pth')
if __name__ == '__main__':
    ...
    args = Namespace(lr=lr, lookback=lookback, lookafter=lookafter,model_path=model_path, num_layers=num_layers, hidden_size=hidden_size, n_epochs=n_epochs)
